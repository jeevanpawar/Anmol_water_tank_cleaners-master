...
if(isset($_REQUEST['submit']))
{
	...
	$amc="insert into amc(c_name,a_date,d1,d2,d3,d4,d5,d6,d7,s1,s2,s3,s4,s5,s6,s7) values('".$q_name."','".$q_date."','".$q_d1."','".$q_d2."','".$q_d3."','".$q_d4."','".$q_d5."','".$q_d6."','".$q_d7."','".$q_s1."','".$q_s2."','".$q_s3."','".$q_s4."','".$q_s5."','".$q_s6."','".$q_s7."')";
	$amc_res=mysql_query($amc);
