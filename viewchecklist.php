...
<div id="container">
    ...
    <div class="quo">
        ...
        <tr>
        <td class="l_form" align="left">TANK SIZE UT</td><td><input type="text" class="check" name="c6" value="<?php echo $row_c[8]; ?>"/></td><td><input type="text" class="c_in" name="r6" value="<?php echo $row_c[22]; ?>"/></td>
        </tr>
        <tr>
        <td class="l_form" align="left">TANK SIZE OT</td><td><input type="text" class="check" name="c7" value="<?php echo $row_c[9]; ?>"/></td><td><input type="text" class="c_in" name="r7" value="<?php echo $row_c[23]; ?>"/></td>
        </tr>
        <tr>
        <td class="l_form" align="left">LOAD SHEDDING</td><td><input type="text" class="check" name="c8" value="<?php echo $row_c[10]; ?>"/></td><td><input type="text" class="c_in" name="r8" value="<?php echo $row_c[24]; ?>"/></td>
        </tr>
        <tr>
        <td class="l_form" align="left">H2O SCHEDULE</td><td><input type="text" class="check" name="c9" value="<?php echo $row_c[11]; ?>"/></td><td><input type="text" class="c_in" name="r9" value="<?php echo $row_c[25]; ?>"/></td>
        </tr>
        <tr>
        <td class="l_form" align="left">LIFT</td><td><input type="text" class="check" name="c10" value="<?php echo $row_c[12]; ?>"/></td><td><input type="text" class="c_in" name="r10" value="<?php echo $row_c[26]; ?>"/></td>
        </tr>
        <tr>
        <td class="l_form" align="left">FLOORS</td><td><input type="text" class="check" name="c11" value="<?php echo $row_c[13]; ?>"/></td><td><input type="text" class="c_in" name="r11" value="<?php echo $row_c[27]; ?>"/></td>
        </tr>
        <tr>
        <td class="l_form" align="left">SITE</td><td ><input type="text" class="check" name="c12" value="<?php echo $row_c[14]; ?>"/></td><td><input type="text" class="c_in" name="r12" value="<?php echo $row_c[28]; ?>"/></td>
        </tr>
        </table>
        <table class="c_last">
        <tr>
